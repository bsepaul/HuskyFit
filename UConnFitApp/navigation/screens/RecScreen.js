    ...
    return (
        <SafeAreaView style={{flex:1, justifyContent:'center',alignItems:'center'}}>
            <View style= {{paddingHorizontal:25}}>
                ...
                <InputField label ={'Workout Type'} keyboardType = 'workout-type' /> 

                <InputField label ={'Time Elapsed'} inputType = 'time-elapsed' />
                <InputField label ={'Calories Burned (Optional)'} inputType = 'calories-burned' 
                fieldButtonFunction = {() => {}}
                />

                <CustomButton label={'Submit'} onPress = {handleLogin}/>
